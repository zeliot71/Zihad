...
const testimonials = [
  {
    testimonial:
      "I thought it was impossible to make a website as beautiful as our product, but Zihad proved me wrong.",
    name: "MD Mustaqeem",
  ...
  {
    testimonial:
      "I've never met a web developer who truly cares about their clients' success like Zihad does.",
    name: "Abdul Raheman",
  ...
  {
    testimonial:
      "After Zihad optimized our website, our traffic increased by 50%. We can't thank them enough!",
    name: "James Wang",
    designation: "CTO",
